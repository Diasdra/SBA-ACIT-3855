...
def returnCar(body):
    ...
    res =  requests.post(app_config['return']['url'], headers={'Content-Type' : 'application/json'}, json=body)
...
def rentCar(body):
    ...
    res = requests.post(app_config['car']['url'], headers={'Content-Type' : 'application/json'}, data=json.dumps(body))
